...
const difficulties: { value: BotDifficulty; label: string; desc: string }[] = [
	...
	{ value: "Medium", label: "Medium", desc: "A fair challenge" },
	{ value: "Hard", label: "Hard", desc: "Unbeatable" },
];
...
export default function BotSlotToggle({
	...
	const handleSetDifficulty = async (difficulty: BotDifficulty) => {
		setLoading(true);
		try {
