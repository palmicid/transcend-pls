  ...
  const content = useMemo(() => {
    if (kind === "terms") {
      return [
        ...
        { h: "2) What this Service is", p: "This project provides a simple platform for users to log in, view a profile, chat, manage friends, and play mini games (e.g., Tic-Tac-Toe). Some features may be mock/demo features for development and testing." },
